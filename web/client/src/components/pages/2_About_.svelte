...
<GridContent 
    title="About Us"
    paragraphs="
    MeowRun is a 3D Unity game created by three South Korean software engineers.
    Welcome to MeowRun, your number one 3D game refresh yourself. We're dedicated to giving you the very best of game experience, with a focus on portable and easy, user-centric and uniqueness.
